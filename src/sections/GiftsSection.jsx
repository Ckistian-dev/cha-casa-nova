...
const GiftsSection = () => {
    ...
    return (
        <section id="gifts" className="py-20 sm:py-32 px-6 bg-beige">
            <div className="container mx-auto text-center">
                <motion.h2 {...animationProps} className="text-6xl sm:text-7xl text-sage-green mb-4">Como nos Presentear</motion.h2>
                <motion.p {...animationProps} transition={{ ...animationProps.transition, delay: 0.2 }} className="font-montserrat text-sage-green/90 max-w-3xl mx-auto mb-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 text-left">
                    <motion.div {...animationProps} transition={{ ...animationProps.transition, delay: 0.4 }}>
                        ...
                        <p className="font-montserrat text-sage-green/90 mb-6">
                    ...
                    <motion.div {...animationProps} transition={{ ...animationProps.transition, delay: 0.6 }}>
                        ...
                        <p className="font-montserrat text-sage-green/90">
